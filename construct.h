...
inline void construct(T1* ptr, const T2& value) { new(ptr) T1(value); }

template<typename T1, typename T2>
inline void construct(T1* ptr, T2&& value) { new(ptr) T1(value); }

template<typename T>
inline void construct(T* ptr) { new(ptr) T(); }
